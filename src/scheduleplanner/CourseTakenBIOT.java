...
import static scheduleplanner.CourseTakenBIOP.core;

/**
 *
 * @author Matthew_PC
 */
public class CourseTakenBIOT extends javax.swing.JPanel {
    ...
    public CourseTakenBIOT() {
        ...
        op.printList(op.courseTaken(chemlbl, 12.00, chemistry, transcript), chemtxt);
    ...
    private void CreateDocActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CreateDocActionPerformed
        ...
        try{
            ...
            core = CourseRequirementsBIOT.createCore();
            op.createDocumentAudit("Core", core, transcript, doc);
            
            //Creates the Biodiversity Discipline subsection in the document
            //See the Operations Class Documentation for Operation method calls
            biodiversityDiscipline = CourseRequirementsBIOT.createBiodiversityDiscipline();
            ...
            //See the Operations Class Documentation for Operation method calls
            molecularBiologyDiscipline = CourseRequirementsBIOT.createMolecularBiologyDiscipline();
            op.createDocumentAudit("Molecular Biology Discipline", molecularBiologyDiscipline, transcript, doc);
            
            //Creates the Organismal Biology Discipline subsection in the document
            //See the Operations Class Documentation for Operation method calls
            organismalBiologyDiscipline = CourseRequirementsBIOT.createOrganismalBiologyDiscipline();
            ...
            //See the Operations Class Documentation for Operation method calls
            ecologyDiscipline = CourseRequirementsBIOT.createEcologyDiscipline();
            ...
            //See the Operations Class Documentation for Operation method calls
            scienceElectives = CourseRequirementsBIOT.createScienceElectives();
