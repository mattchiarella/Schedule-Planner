...
import static scheduleplanner.CourseTakenBIOT.scienceElectives;

/**
 *
 * @author Matthew_PC
 */
public class CourseRequirementsBIOT extends javax.swing.JPanel {
    ...
    {
        ArrayList<Authentication.course> c = new ArrayList<Authentication.course>();
        c.add(new Authentication.course("PHY", "151", "", "Introductory Physics", "", "3", ""));
        c.add(new Authentication.course("PHY", "151L", "", "Introductory Physics LAB", "", "1", ""));
    ...
    public static ArrayList<Authentication.course> createBiodiversityDiscipline(){
        ArrayList<Authentication.course> c = new ArrayList<Authentication.course>();
    ...
    public static ArrayList<Authentication.course> createMolecularBiologyDiscipline(){
        ArrayList<Authentication.course> c = new ArrayList<Authentication.course>();
    ...
    public static ArrayList<Authentication.course> createOrganismalBiologyDiscipline(){
        ArrayList<Authentication.course> c = new ArrayList<Authentication.course>();
    ...
    public static ArrayList<Authentication.course> createEcologyDiscipline(){
        ArrayList<Authentication.course> c = new ArrayList<Authentication.course>();
    ...
    public static ArrayList<Authentication.course> createMathRequirements(){
        ...
        c.add(new Authentication.course("MAT","152","","Probability and Stats","","4",""));
        return c;
    }
    ...
    public static ArrayList<Authentication.course> createChemistry(){
        ...
        c.add(new Authentication.course("CHE","152","","Introductory Organic Chemistry","","3",""));
        c.add(new Authentication.course("CHE","152L","","Introductory Organic Chemistry Lab","","1",""));
        return c;
    }
    ...
    /**
     * Creates new form CourseRequirementsBIOT
     */
    public CourseRequirementsBIOT() {
        initComponents();
        ...
        core = createCore();
        op.courseElim(corelbl, 11.00, core, transcript);
        ...
        biodiversityDiscipline = createBiodiversityDiscipline();
        op.courseElim(biodlbl, 3.00,biodiversityDiscipline,transcript);
        op.printList(biodiversityDiscipline, biodtxt);
        
        molecularBiologyDiscipline = createMolecularBiologyDiscipline();
        op.courseElim(molelbl, 3.00, molecularBiologyDiscipline, transcript);
        op.printList(molecularBiologyDiscipline, moletxt);
        
        organismalBiologyDiscipline = createOrganismalBiologyDiscipline();
        op.courseElim(orgalbl, 3, organismalBiologyDiscipline, transcript);
        op.printList(organismalBiologyDiscipline, orgatxt);
        
        ecologyDiscipline = createEcologyDiscipline();
        op.courseElim(ecollbl, 3.00, ecologyDiscipline, transcript);
        op.printList(ecologyDiscipline, ecoltxt);
        ...
        op.courseElim(chemlbl, 12.00, chemistry, transcript);
        ...
        op.courseTaken(physlbl, 4.00, scienceElectives, transcript);
